Full Program: Calculating Net Profit in Lobster Fisheries Adjacent to MPAs,depending on MPA Size

This (simplified) program calculates the net profit incurred by lobster fisheries due to MPA spillover
